...
public class ValidationMessages {
	...
	public static String passwordLeastCharacter = "The password must be at least [x] characters.";
	public static String firstNameLeastCharacter = "The password must be at least [x] characters.";
	public static String lastNameLeastCharacter = "The password must be at least [x] characters.";
	...
	public static String userAccounNeedsToBeActivated = "User Account Needs to be Activated"; 
